...
@section('content')
    ...
    <section class="jumbotron text-center">
        <div class="container container-text-big">
            <p class="lead text-muted text-principal text-justify">La Aldea cuenta con jardines en 
                <span>varios tamaños y áreas </span>
    ...
    <section class="container-servicios">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-6 servicio-imagen">
            </div>
